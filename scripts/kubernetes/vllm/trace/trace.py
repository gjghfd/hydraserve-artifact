'''
Source: https://github.com/alpa-projects/mms/blob/dba47b18e95f037aadc8aff336e2e7e337010495/alpa_serve/trace/trace.py
'''
...
class TraceReplay:
    ...
    def visualize(self, n_interval=100):
        ...
        fig_name = f"{self.model.replace('/', '.')}-{self.trace_name}-{self.arrival_distribution}-" \
