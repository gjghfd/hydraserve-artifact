...
class SequenceGroup:
    ...
    def __init__(
        ...
        self.use_dest = use_dest     # whether this request uses dest model
        self.in_process = False      # whether this request is in process by pipeline stages
...
class ExecuteModelRequest:
    ...
    # Whether we have changed to dest status
    use_dest: bool = False
