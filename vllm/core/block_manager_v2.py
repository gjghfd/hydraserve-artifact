...
class BlockSpaceManagerV2(BlockSpaceManager):
    ...
    def extend_gpu_blocks(self, num_target_gpu_blocks: int):
        raise NotImplementedError("extend_gpu_blocks for block manager v2 is not supported.")
        # TODO(chiheng): support extend_gpu_blocks
        # self.block_allocator.extend_gpu_blocks(num_target_gpu_blocks)
