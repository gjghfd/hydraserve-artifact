...
class ModelRunner:
    ...
    def load_dest_model(self):
        with CudaMemoryProfiler() as m:
            self.dest_model = get_model(
    ...
    def execute_model(
        ...
        if prefill_meta is None and decode_meta.use_cuda_graph:
            ...
            model_executable = self.dest_model if use_dest else self.model
        ...
        # Compute the logits.
        if use_dest:
            logits = self.dest_model.compute_logits(hidden_states, sampling_metadata)
        else:
