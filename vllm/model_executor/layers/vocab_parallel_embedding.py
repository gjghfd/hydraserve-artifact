...
class VocabParallelEmbedding(torch.nn.Module):
    ...
    def weight_loader(self, param: Parameter, loaded_weight: torch.Tensor):
        ...
        if loaded_weight.shape[parallel_dim] != self.org_vocab_size:
            print(f"Warning: org_vocab_size = {self.org_vocab_size}, loaded_weight has vocab size = {loaded_weight.shape[parallel_dim]}")
