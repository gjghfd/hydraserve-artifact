...
class ModelConfig:
    ...
    def get_num_layers(self, parallel_config: "ParallelConfig") -> int:
        ...
        # allocate dest layers KV cache
        dest_num_layers = int(os.getenv('DEST_NUM_LAYERS', '0'))
        if dest_num_layers > 0:
            total_num_hidden_layers = dest_num_layers
    ...
    def __init__(
        ...
        if max_num_batched_tokens is not None:
            ...
            if enable_chunked_prefill:
                ...
                logger.info("Set max_num_batched_tokens to 16 * 4096")
                self.max_num_batched_tokens = 16 * 4096
        if enable_chunked_prefill:
